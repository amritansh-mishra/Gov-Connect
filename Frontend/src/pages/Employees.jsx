    ...
    <div className="p-6">
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-lightText mt-1">Manage employee information and organizational structure.</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredEmployees.map((employee) => (
          <div key={employee.id} className="bg-background/50 rounded-xl shadow-lg border border-gray-700 p-6 hover:shadow-xl transition-all">
            <div className="flex items-start space-x-4 mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-lightText">{employee.role}</p>
                <span className="inline-block px-2 py-1 text-xs bg-green-900/50 text-green-300 rounded-full mt-1">
                  Active
                </span>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-gray-700 mt-4">
              <button className="w-full py-2 px-4 bg-gray-700/50 text-gray-300 rounded-lg hover:bg-gray-600/50 transition-colors font-medium">
                View Profile
              </button>
            </div>
          </div>
